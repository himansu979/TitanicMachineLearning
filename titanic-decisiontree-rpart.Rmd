...
We will use the R build-in function **rpart** to build the **decisionTree** model (CART).
...
# here method is class by default for factor variable, class(Survived) = integer
```
